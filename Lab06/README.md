# Weather App# Week 6 - Weather Application



Simple weather application that shows current weather data.## Aim
...
Open `index.html` in your browser.## Features Implemented



## Features1. **Simple UI Design**

- Search weather by city name   - Input field for city name

- Shows temperature and conditions   - Button to fetch weather details

- Saves last search   - Section to display weather output
