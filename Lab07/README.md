# Bookstore App# Week 7 - Modular JavaScript and Working with JSON (Online Bookstore)



Online bookstore with shopping cart.## Aim

Modular JavaScript and Working with JSON (Online Bookstore)

## How to Run

Open `index.html` in browser or use a local server.## Description

This project demonstrates:

## Features1. Creating a JSON data file containing a list of books with properties: title, author, price, availability

- Browse books2. Structuring code using JavaScript modules:

- Add to cart   - A module for displaying book listings

- Calculate total   - A module for managing the shopping cart (add, remove, calculate total)
