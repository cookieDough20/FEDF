# To-Do List# Week 8 - To-Do List Application with React Hooks



React-based task manager.## Aim
...
npm run dev│   └── db.json                 # JSON Server database file (stores tasks)
...
- Add/delete tasks    │   ├── components/

- Mark complete    │   │   ├── TaskForm.jsx    # Component for adding and editing tasks

- Data persistence    │   │   ├── TaskList.jsx    # Component for rendering task list
